...
var KY_DICT = {
	...
	"У каждого материала есть бесплатный анонс — смотрите прямо на сайте.": "Ар бир материалдын акысыз анонсу бар — сайттан эле көрүңүз.",
	...
	"Вебинары": "Вебинарлар",
	"Семинары": "Семинарлар",
	"Запись на встречу": "Жолугушууга жазылуу",
	"Онлайн и очно": "Онлайн жана жандуу",
	"Семинары, вебинары и консультации — онлайн и очно. Выберите формат и время в календаре ниже, запись займёт минуту.": "Семинарлар, вебинарлар жана консультациялар — онлайн жана жандуу. Төмөнкү календардан форматты жана убакытты тандаңыз, жазылуу бир мүнөт алат.",
	"Что сколько стоит (в токенах)": "Эмне канча турат (токендер менен)",
	"Курсы": "Курстар",
	"Купить": "Сатып алуу",
	...
	"Мы ещё не подключили оплату на сайте — сейчас пользуйтесь бесплатными пробными токенами. Как только оплата заработает, пакеты станут доступны здесь.": "Сайтка төлөмдү али кошо элекпиз — азырынча акысыз пробный токендерди колдонуңуз. Төлөм иштей баштайт, пакеттер ушул жерде жеткиликтүү болот.",
