...
var KY_DICT = {
	...
	"GN FinTrust — практические финансы": "GN FinTrust — практикалык финансы",
		...
		"Выберите формат и свободное время — запись прямо на этой странице, без Google Календаря.": "Форматты жана бош убакытты тандаңыз — жазылуу ушул баракта, Google Календарсыз.",
		"Все форматы": "Бардык форматтар",
		"Онлайн": "Онлайн",
		"Очно": "Оффлайн",
