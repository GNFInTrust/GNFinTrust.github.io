...
var KY_DICT = {
	...
	"Чтобы доступ открылся автоматически, войдите или зарегистрируйтесь — покупка привяжется к вашему аккаунту.": "Мүмкүнчүлүк автоматтык түрдө ачылышы үчүн кириңиз же катталыңыз — сатып алуу аккаунтуңузга байланат.",
		...
		"Три шага": "Үч кадам",
		"Одна оплата · доступ навсегда": "Бир төлөм · түбөлүк кирүү",
		"Практические вебинары, семинары и курсы по финансам и бухгалтерии.": "Каржы жана бухгалтерия боюнча практикалык вебинарлар, семинарлар жана курстар.",
		"Оплата переводом · доступ в кабинете": "Которуу менен төлөм · кабинетте кирүү",
	}
